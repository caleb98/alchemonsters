...
if isHit then
	...
	Damage:publish(luajava.newInstance(_MCombatDamageDealt, context, source, target, move.name, move.elementType, damage, isHit, isCrit, false))
	...
	Damage:publish(luajava.newInstance(_MCombatHealingReceived, context, source, source, "Drain", healing, false))
end
