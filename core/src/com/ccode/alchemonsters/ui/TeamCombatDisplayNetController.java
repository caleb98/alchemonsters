...
public class TeamCombatDisplayNetController extends Table implements Subscriber {
	...
	public TeamCombatDisplayNetController(String teamName) {
		...
		ActiveDisplay(int teamId) {
			...
			submitButton.addListener(new ClickListener() {
				...
				public void clicked(InputEvent event, float x, float y) {
					...
					TeamCombatDisplayNetController.this.updateStrings();
				}
			});
