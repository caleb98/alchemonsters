...
public class MainMenuScreen implements Screen {
	...
	public void show() {
		...
		Image titleSplash = new Image(new Texture(Gdx.files.internal("data/sprites/title_splash.png")));
		titleHighlight = new Image(new Texture(Gdx.files.internal("data/sprites/title_splash_highlight.png")));
